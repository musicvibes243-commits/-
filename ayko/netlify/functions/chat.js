...
- Что умеют боты: принимают заявку без анкеты (вопросы по одному, ответы кнопками), сами записывают заявки в Google Таблицу, сразу уведомляют владельца или администратора, записывают клиента на свободное время, отвечают на частые вопросы (цены, адрес, график). Можно добавить другие функции под задачи бизнеса — обсуждается после заявки.
