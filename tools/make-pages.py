...
},
{
 ...
 "photos": [
   ...
   ("avtopoliv-gazon-01.jpg",
    "Четыре дождевателя поливают зелёный газон вдоль живой изгороди из туй",
    "Полив газона в работе", "Зоны перекрываются веером — сухих пятен не остаётся"),
