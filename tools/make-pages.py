...
},
{
 ...
 "photos": [
   ...
   ("avtopoliv-terrasa-01.jpg",
    "Дождеватели поливают газон вдоль керамогранитной террасы с колоннами",
    "Кромка у террасы", "Сектор выставлен по краю газона, чтобы вода не летела на плитку"),
