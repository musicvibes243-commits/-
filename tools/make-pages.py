...
PAGES = [
{
 ...
 "photos": [
   ("kotelnaya-obshchiy-01.jpg",
    "Котельная в готовом доме: электрокотёл, красный расширительный бак, бойлер и синий гидроаккумулятор",
    "Котельная целиком", "Котёл, расширительный бак, бойлер и гидроаккумулятор — всё в одной комнате"),
   ("kollektor-rashodomery-01.jpg",
    "Коллектор тёплого пола на шесть контуров: расходомеры, термоголовки, манометры и воздухоотводчики",
    "Коллектор тёплого пола", "Шесть контуров, на каждом расходомер — потоки балансируются по комнатам"),
