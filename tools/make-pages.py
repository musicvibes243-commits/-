...
PAGES = [
{
 ...
 "photos": [
   ...
   ("tepliy-pol-kontury-01.jpg",
    "Контуры водяного тёплого пола уложены улиткой на армирующей сетке, на стене коллекторный шкаф",
    "Контуры тёплого пола", "Кладём улиткой: подача и обратка идут рядом, пол греет ровно"),
   ("konvektor-v-polu-01.jpg",
    "Внутрипольный конвектор с решёткой вровень с полом у панорамного окна, рядом контуры тёплого пола",
    "Конвектор в полу", "Решётка вровень с полом: у панорамного окна радиатор перекрыл бы вид"),
