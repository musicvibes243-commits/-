...
PAGES = [
{
 ...
 "photos": [
   ...
   ("razvodka-sanuzel-01.jpg",
    "Разводка полипропиленовых труб по стене санузла, выводы под смеситель и канализационный стояк",
    "Разводка по санузлу", "Выводы под смеситель и технику, стояк и трапы — всё до отделки"),
 ],
...
},
{
 ...
 "photos": [
   ("avtopoliv-gazon-01.jpg",
    ...
    "Полив газона в работе", "Зоны перекрываются веером — сухих пятен на газоне не остаётся"),
