...
},
{
 ...
 "photos": [
   ...
   ("avtopoliv-pult-01.jpg",
    "Контроллер полива Hunter на стене рядом с накопительной ёмкостью для воды",
    "Пульт и запас воды", "Расписание по зонам задаётся один раз — дальше полив идёт сам, ночью"),
   ...
   ("avtopoliv-klapany-01.jpg",
    "Узел клапанов автополива с трубами ПНД у стены теплицы",
    "Узел клапанов у теплицы", "Отдельная зона на грядки: своё расписание и свой напор"),
 ],
 "other": [("Отопление и тёплые полы", "otoplenie.html"),
