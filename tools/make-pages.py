...
PAGES = [
{
 ...
 "photos": [
   ("kollektor-tepliy-pol-01.jpg",
    "Коллекторный шкаф тёплого пола, из него выходят красные и синие трубы в гофре",
    "Коллектор тёплого пола", "Каждый контур заведён отдельно — температуру можно настроить по комнатам"),
