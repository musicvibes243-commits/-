...
PAGES = [
{
 ...
 "photos": [
   ...
   ("tepliy-pol-kontury-01.jpg",
    "Контуры водяного тёплого пола из красной трубы закреплены на армирующей сетке по всей комнате",
    "Контуры тёплого пола", "Труба уложена и закреплена — дальше опрессовка, и только потом стяжка"),
