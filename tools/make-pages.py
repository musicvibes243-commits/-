...
PAGES = [
{
 ...
 "photos": [
   ...
   ("kotelnaya-elektrokotel-01.jpg",
    "Электрокотёл с обвязкой на стене из газоблока: насос на подаче, красный расширительный бак, рядом водонагреватель",
    "Электрокотёл с обвязкой", "Насос, расширительный бак и бойлер — одним узлом на одной стене"),
 ...
 "other": [("Электрика в доме и на участке", "elektrika.html"),
           ("Водоснабжение дома", "vodosnabzhenie.html"),
           ("Дренаж и ливнёвка", "drenazh.html"),
           ("Септики и кессоны", "index.html")],
},
{
 "file": "elektrika.html",
 "slug": "elektrika",
...
{
 "file": "vodosnabzhenie.html",
 "slug": "vodosnabzhenie",
 "title": "Водоснабжение дома под ключ — кессон, ввод, разводка | СтройИнвест",
 "desc": "Водоснабжение частного дома под ключ по Москве и Московской области: кессон над скважиной, ввод воды в дом ниже промерзания, разводка по точкам, фильтры и водонагреватель. Выезд и расчёт бесплатно.",
 "eyebrow": "Водоснабжение",
 "h1": 'Водоснабжение дома <span>от скважины до крана</span>',
 "lead": "Ставим кессон, заводим воду в дом, разводим по точкам и подключаем технику. "
         "Зимой не встаёт: труба идёт ниже глубины промерзания. Москва и Московская область.",
 "chips": ["Кессон над скважиной", "Ввод воды в дом", "Разводка по точкам", "Фильтры и водонагреватель"],
 "service_name": "Монтаж водоснабжения частного дома",
 "cards": [
   ("Кессон над скважиной",
    "Ставим и утепляем кессон, заводим внутрь оголовок, насосное оборудование и автоматику. "
    "В кессон можно спуститься: поменять реле или снять насос без раскопок.",
    '<ellipse cx="20" cy="12" rx="12" ry="4"/><path d="M8 12v18c0 2.2 5.4 4 12 4s12-1.8 12-4V12"/><path d="M20 4v8"/>'),
   ("Ввод воды в дом",
    "Копаем траншею ниже глубины промерзания, укладываем трубу в утеплителе и заводим "
    "в дом через гильзу. Ставим запорную арматуру и фильтр грубой очистки.",
    '<path d="M10 34V18l10-8 10 8v16z"/><path d="M2 30h8v4"/><circle cx="20" cy="26" r="3"/>'),
   ("Разводка по дому",
    "Ведём трубы к каждой точке: кухня, санузлы, котельная, уличный кран. Коллекторная "
    "или тройниковая схема — на замере считаем, что выгоднее в вашем доме.",
    '<path d="M6 10h28"/><path d="M12 10v10h16v14"/><path d="M12 20v14"/><circle cx="12" cy="34" r="2"/><circle cx="28" cy="34" r="2"/>'),
   ("Фильтры и горячая вода",
    "Подбираем фильтрацию по анализу воды, ставим водонагреватель или бойлер косвенного "
    "нагрева, собираем обвязку с краном на каждой линии.",
    '<path d="M13 11a7 7 0 0 1 14 0v18a7 7 0 0 1-14 0z"/><path d="M20 4v7"/><path d="M17 36h6"/>'),
 ],
 "steps": [
   ("Выезд и осмотр", "Смотрим скважину, дом и участок: глубина, куда вести трубу, сколько точек воды.", "бесплатно"),
   ("Схема и смета", "Считаем оборудование и метраж, показываем смету до начала работ.", "1–2 дня"),
   ("Монтаж", "Кессон, траншея, ввод в дом, разводка, фильтры, подключение техники.", "2–7 дней"),
   ("Запуск и сдача", "Опрессовываем, проверяем каждую точку, показываем, где что перекрывается.", "в день сдачи"),
 ],
 "faq": [
   ("Зимой вода не замёрзнет?",
    "Труба идёт ниже глубины промерзания — в Подмосковье это 1,5–1,8 метра — и дополнительно "
    "в утеплителе. Кессон утеплён, внутри держится плюс за счёт тепла земли. Ввод в дом делаем "
    "через гильзу, чтобы трубу не зажало при подвижках грунта."),
   ("Кессон или скважинный адаптер?",
    "В кессон можно спуститься и обслужить оборудование: поменять реле давления, почистить фильтр, "
    "снять насос. С адаптером при любой неисправности участок придётся копать заново. Адаптер дешевле "
    "и на небольшой глубине оправдан — скажем честно, когда он вам подойдёт."),
   ("Нужен ли анализ воды?",
    "Для подбора фильтров — да. Без него фильтрация ставится наугад: в одной скважине железо, "
    "в соседней жёсткость, и фильтр под чужую проблему просто не сработает. Подскажем, куда сдать "
    "пробу и что заказывать в лаборатории."),
   ("Делаете ли зимой?",
    "Разводку внутри дома, фильтры и обвязку — круглый год. Кессон и траншею копаем, пока грунт "
    "не промёрз глубоко: в сильный мороз земляные работы идут дольше и стоят дороже. "
    "Если скважина уже есть, а дом подключить надо сейчас, приедем и посмотрим."),
   ("Сколько стоит?",
    "Зависит от глубины скважины, расстояния до дома и числа точек воды. Считаем после выезда "
    "и называем окончательную сумму до начала работ. Выезд бесплатный."),
 ],
 "select": ["Кессон над скважиной", "Ввод воды в дом", "Разводка по дому",
            "Фильтры и водонагреватель", "Пока не определился"],
 "placeholder": "Что уже есть: пробурена ли скважина, какая глубина, сколько точек воды планируете",
 "photos": [
   ("kesson-skvazhina-01.jpg",
    "Вид сверху в пластиковый кессон: оголовок скважины, гидроаккумулятор с реле давления и манометром, лестница",
    "Кессон над скважиной", "Спускаемся и обслуживаем — откапывать ничего не надо"),
   ("kesson-oborudovanie-01.jpg",
    "Гидроаккумулятор с реле давления и манометром внутри кессона, рядом оголовок скважины и сливной кран",
    "Автоматика в кессоне", "Реле и манометр на виду: давление проверяется за секунду"),
   ("vodosnabzhenie-uzel-01.jpg",
    "Узел ввода воды в доме: гидроаккумулятор, косой фильтр грубой очистки и колба фильтра на стене из газоблока",
    "Узел ввода в доме", "Фильтр и краны в одном месте — воду перекрыть можно не бегая по дому"),
   ("vodosnabzhenie-gidroak-01.jpg",
    "Гидроаккумулятор на стене рядом с водонагревателем и расширительным баком, разводка белыми трубами",
    "Гидроаккумулятор и бойлер", "Холодная и горячая вода собраны в одной котельной, рядом с отоплением"),
   ("boiler-ariston-01.jpg",
    "Настенный водонагреватель Ariston с обвязкой, фильтром и запорными кранами",
    "Водонагреватель с обвязкой", "Кран на каждой линии: обслуживать можно, не сливая систему"),
   ("razvodka-karkas-01.jpg",
    "Трубы воды и канализации разведены по стойкам каркаса, на полу сетка под стяжку",
    "Разводка по каркасу", "Развели до зашивки стен — потом уже не переделать"),
   ("razvodka-sanuzel-01.jpg",
    "Санузел до отделки: трубы воды по стене, канализация с ревизией, установлен унитаз",
    "Разводка в санузле", "Выводы под раковину и унитаз собраны до отделки"),
 ],
 "other": [("Отопление и тёплые полы", "otoplenie.html"),
...
},
{
 "file": "drenazh.html",
 "slug": "drenazh",
 "title": "Дренаж участка под ключ — пристенный и ливнёвка | СтройИнвест",
 "desc": "Дренаж участка и фундамента под ключ по Москве и Московской области: пристенный и кольцевой дренаж, ливневая канализация, смотровые колодцы. Уклон бьём нивелиром. Выезд и расчёт бесплатно.",
 "eyebrow": "Дренаж и ливнёвка",
 "h1": 'Дренаж участка <span>и отвод воды от дома</span>',
 "lead": "Вода уходит с участка, а не стоит в подвале и на дорожках. Копаем, укладываем трубу "
         "в щебне и геотекстиле, ставим колодцы. Уклон бьём нивелиром. Москва и Московская область.",
 "chips": ["Пристенный дренаж", "Кольцевой дренаж", "Ливневая канализация", "Смотровые колодцы"],
 "service_name": "Монтаж дренажа участка и фундамента",
 "promo": ("Скидка 33%", "4 000 ₽", "2 680 ₽", "за погонный метр",
           "Скидка действует на монтаж дренажа при заказе до 15 октября 2026 года. "
           "Окончательную сумму считаем на замере: она зависит от глубины траншеи, "
           "числа колодцев и куда отводится вода."),
 "cards": [
   ("Пристенный дренаж",
    "Труба по периметру фундамента ниже подошвы, в щебне и геотекстиле. Вода не стоит "
    "у стен и не идёт в подвал через швы и трещины.",
    '<path d="M12 4h16v22H12z"/><path d="M4 32h32"/><path d="M8 32v-4M32 32v-4"/>'),
   ("Кольцевой дренаж участка",
    "Контур по границе участка или вокруг дома с выводом в колодец, канаву или накопитель. "
    "Для участков, где вода стоит после каждого дождя.",
    '<circle cx="20" cy="20" r="13"/><path d="M20 7v6M20 27v6M7 20h6M27 20h6"/>'),
   ("Ливневая канализация",
    "Дождеприёмники под водостоками, лотки вдоль дорожек, труба в общий выпуск. "
    "Вода с крыши не размывает отмостку и не стоит у крыльца.",
    '<path d="M20 4c0 0 8 10 8 15a8 8 0 1 1-16 0c0-5 8-15 8-15z"/><path d="M6 34h28"/>'),
   ("Колодцы и обслуживание",
    "Смотровые и поворотные колодцы на углах и перепадах: систему можно промыть "
    "через несколько лет, не вскрывая участок.",
    '<ellipse cx="20" cy="10" rx="10" ry="4"/><path d="M10 10v20c0 2.2 4.5 4 10 4s10-1.8 10-4V10"/><path d="M14 18h12"/>'),
 ],
 "steps": [
   ("Выезд и осмотр", "Смотрим уклоны участка, где стоит вода, глубину фундамента и куда её отводить.", "бесплатно"),
   ("Схема и смета", "Считаем метраж, щебень и колодцы. Смету показываем до начала работ.", "1–2 дня"),
   ("Земляные работы и монтаж", "Траншея, геотекстиль, щебень, труба с уклоном, колодцы, обратная засыпка.", "2–5 дней"),
   ("Проверка и сдача", "Проливаем систему водой, показываем, как уходит и где колодцы для промывки.", "в день сдачи"),
 ],
 "faq": [
   ("Какой уклон нужен дренажу?",
    "Два миллиметра на метр — то есть два сантиметра на десять метров. На глаз такое не выставить: "
    "ошиблись в обратную сторону, и вода встанет в трубе. Мы бьём уклон нивелиром, он виден "
    "на фотографиях с объектов ниже."),
   ("Чем пристенный дренаж отличается от кольцевого?",
    "Пристенный идёт вплотную к фундаменту и защищает дом: подвал, швы, отмостку. Кольцевой — "
    "контур по участку, он осушает саму территорию, чтобы не хлюпало под ногами и росли растения. "
    "Часто нужны оба, и на замере мы смотрим, откуда именно идёт вода."),
   ("Зачем геотекстиль и щебень, нельзя просто трубу?",
    "Щебень — это объём, в который вода собирается и по которому доходит до трубы. Геотекстиль "
    "не даёт грунту заилить щебень. Без него система работает года три, а потом заплывает, "
    "и всё надо откапывать заново."),
   ("Куда девать собранную воду?",
    "В дренажный колодец, в придорожную канаву, в ливневую сеть посёлка или в накопитель с насосом — "
    "смотря что есть у вас и что разрешено в посёлке. Это решается на замере: от точки сброса "
    "зависит вся схема и уклоны."),
   ("Сколько стоит?",
    "Считается по погонным метрам, глубине траншеи и числу колодцев. Называем сумму после выезда "
    "и до начала работ. Выезд бесплатный."),
 ],
 "select": ["Пристенный дренаж", "Кольцевой дренаж участка", "Ливнёвка",
            "Не знаю, надо посмотреть"],
 "placeholder": "Где стоит вода: у дома, на дорожках, в подвале. Есть ли подвал и куда можно отвести воду",
 "photos": [
   ("drenazh-geotekstil-01.jpg",
    "Глубокая дренажная траншея вдоль дома, стенки застелены геотекстилем, на дне отсыпан щебень, вдали экскаватор",
    "Траншея под дренаж", "Геотекстиль по стенкам, щебень на дне — труба не заиливается"),
   ("transhea-01.jpg",
    "Дренажная траншея с геотекстилем, нивелир на треноге и смотровой колодец на переднем плане",
    "Уклон бьём нивелиром", "Два миллиметра на метр: на глаз такое не выставить"),
   ("drenazh-truba-01.jpg",
    "Дренажная труба в геотекстиле уложена на щебень вдоль фундамента",
    "Труба в геотекстиле", "Обёрнута целиком: грунт внутрь не попадёт"),
   ("shcheben-frakciya-01.jpg",
    "Гранитный щебень на геотекстиле, поперёк лежит рулетка для проверки фракции",
    "Щебень смотрим на месте", "Мелкий забьётся, крупный не задержит воду — проверяем рулеткой"),
 ],
 "other": [("Водоснабжение дома", "vodosnabzhenie.html"),
           ("Отопление и тёплые полы", "otoplenie.html"),
           ("Электрика в доме и на участке", "elektrika.html"),
           ("Септики и кессоны", "index.html")],
},
]
...
<header class="top">
  <div class="wrap top__in">
    ...
    <nav class="nav" aria-label="Основное меню">
      <a href="index.html">Септики</a>
      <a href="drenazh.html">Дренаж</a>
    ...
    <div class="foot__grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="index.html">Кессоны для скважин</a></li>
          <li><a href="drenazh.html">Дренаж и ливнёвка</a></li>
          <li><a href="vodosnabzhenie.html">Водоснабжение дома</a></li>
...
def promo_html(p):
    """Блок со скидкой. Если у направления акции нет — секции нет вовсе.

    Цена указывается за ту же единицу, в которой мастер считает смету,
    иначе человек умножит её на свою площадь и получит не ту сумму.
    Срок окончания обязателен: акция без даты — это уже не акция,
    а обычная цена, и вопросы к ней будут и у людей, и у ФАС.
    """
    pr = p.get("promo")
    if not pr:
        return ""
    badge, old, new, unit, note = pr
    return f'''
<!-- ================= АКЦИЯ ================= -->
<section class="promo-sec">
  <div class="wrap">
    <div class="promo">
      ...
      <p class="promo__prices">
        <s class="promo__old">{old}</s>
        <b class="promo__new">{new}</b>
        <span class="promo__unit">{unit}</span>
      </p>
      <p class="promo__note">{note}</p>
    </div>
  </div>
</section>
'''
