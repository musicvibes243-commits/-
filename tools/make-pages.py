...
PAGES = [
{
 ...
 "photos": [
   ("radiator-montazh-01.jpg",
    "Алюминиевый радиатор на стене каркасного дома, подводка снизу",
    "Радиатор с нижней подводкой", "Трубы уходят в пол — по комнате ничего не тянется"),
   ("boiler-sanuzel-01.jpg",
    "Накопительный водонагреватель и обвязка над унитазом в санузле",
    "Горячая вода в санузле", "Водонагреватель, обвязка и разводка по точкам"),
 ],
...
},
{
 ...
 "photos": [
   ("avtopoliv-gazon-01.jpg",
    "Работающие дождеватели поливают зелёный газон вдоль живой изгороди",
    "Полив газона в работе", "Дождеватели поднимаются только на время полива — косилке не мешают"),
